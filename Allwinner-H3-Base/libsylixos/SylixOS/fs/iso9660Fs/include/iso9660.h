...
extern enum iso_enum1_s {
  ...
  ISO_BLOCK_SHIFT     = 11,
  ISO_BLOCK_MASK      = (ISO_BLOCKSIZE - 1)
} iso_enums1;
...
typedef struct _iso9660_s iso9660_t;
  ...
  */
  iso9660_t *iso9660_open (int drv_num /*flags, mode */);
  ...
  */
  iso9660_t *iso9660_open_ext (int drv_num,
  ...
  */
  iso9660_t *iso9660_open_fuzzy (int drv_num /*flags, mode */,
                                 uint16_t i_fuzz);
  ...
  */
  iso9660_t *iso9660_open_fuzzy_ext (int drv_num,
                                     iso_extension_mask_t iso_extension_mask,
                                     uint16_t i_fuzz
                                     /*flags, mode */);
