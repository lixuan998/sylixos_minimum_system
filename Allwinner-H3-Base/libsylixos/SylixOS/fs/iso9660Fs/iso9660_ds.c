...
_cdio_list_new (void)
{
  CdioList_t *p_new_obj = cdio_calloc (1, sizeof (CdioList_t));
...
_cdio_list_prepend (CdioList_t *p_list, void *p_data)
{
  ...
  p_new_node = cdio_calloc (1, sizeof (CdioListNode_t));
...
_cdio_list_append (CdioList_t *p_list, void *p_data)
{
  ...
  if (p_list->length == 0)
    ...
    {
      CdioListNode_t *p_new_node = cdio_calloc (1, sizeof (CdioListNode_t));
      cdio_assert (p_new_node != NULL);
