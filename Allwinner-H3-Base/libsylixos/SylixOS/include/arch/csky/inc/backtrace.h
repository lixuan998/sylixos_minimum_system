...
#ifndef __CSKY_BACKTRACE_H
#define __CSKY_BACKTRACE_H
...
#define V2_16_IS_RTS(insn)           ((insn) == 0x783c)                 /* rts                          */
#define V2_16_IS_MOV_SP_FP(insn)     ((insn) == 0x6fa3)                 /* move sp, r8                  */
#define V2_16_IS_ADDI14(x)            (((x) & 0xfce0) == 0x1400)        /* addi sp, sp, oimm8           */
